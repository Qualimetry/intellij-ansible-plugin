...
- **SonarQube import** — import active rules from a SonarQube quality profile via the IDE's main menu bar (**Tools > Qualimetry Ansible > Import Rules from SonarQube**) or the **Import from SonarQube...** button on the settings page.
...
- The IDE's **main menu bar**: **Tools > Qualimetry Ansible > Import Rules from SonarQube**. This is the Tools menu at the top of the IDE window — not the Settings > Tools section. In Rider's new UI, the menu bar is behind the hamburger icon.
- The **Import from SonarQube...** button on the settings page (**Settings > Tools > Qualimetry Ansible Analyzer**).
