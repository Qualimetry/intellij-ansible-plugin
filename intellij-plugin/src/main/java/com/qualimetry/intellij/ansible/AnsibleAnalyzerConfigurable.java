...
/**
 * Settings UI under Settings &gt; Tools &gt; Qualimetry Ansible Analyzer.
 */
public final class AnsibleAnalyzerConfigurable implements Configurable {

    private AnsibleAnalyzerSettingsPanel panel;

    @Nls(capitalization = Nls.Capitalization.Title)
    @Override
    public String getDisplayName() {
        return "Qualimetry Ansible Analyzer";
    }

    @Nullable
    @Override
    public JComponent createComponent() {
        panel = new AnsibleAnalyzerSettingsPanel();
    ...
    public boolean isModified() {
        ...
        AnsibleAnalyzerSettings temp = new AnsibleAnalyzerSettings();
