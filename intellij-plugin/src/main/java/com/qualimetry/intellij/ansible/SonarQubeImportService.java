...
final class SonarQubeImportService {
    ...
    private void extractRuleKeysFromRulesResponse(String body, Map<String, AnsibleAnalyzerSettings.RuleOverride> out) {
        int i = 0;
        while ((i = body.indexOf(REPO_PREFIX, i)) >= 0) {
            ...
            if (end > start) {
                ...
                if (!ruleKey.isEmpty()) {
                    out.put(ruleKey, new AnsibleAnalyzerSettings.RuleOverride(true, null));
                }
            }
